...
function StreamTransfer({
  ...
  let scriptTag = value ? /*#__PURE__*/React__namespace.createElement("script", {
    ...
    dangerouslySetInnerHTML: {
      __html: `window.__remixContext.streamController.enqueue(${markup.escapeHtml(JSON.stringify(value))});`
    }
  }) : null;
  if (done) {
  ...
  return turboStream.decode(body, {
    plugins: [(type, ...rest) => {
      ...
      if (type === "ErrorResponse") {
        ...
        return {
          value: new router.UNSAFE_ErrorResponseImpl(status, statusText, data)
        };
      }
      if (type === "SingleFetchRedirect") {
        return {
          value: {
            [serverRuntime.UNSAFE_SingleFetchRedirectSymbol]: rest[0]
          }
        };
      }
    }, (type, value) => {
...
function unwrapSingleFetchResults(results, routeId) {
  let redirect = results[serverRuntime.UNSAFE_SingleFetchRedirectSymbol];
  if (redirect) {
