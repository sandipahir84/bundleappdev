...
// node_modules/@shopify/app-bridge-react/dist/index.js
...
` + i[l].replace(" at new ", " at ");
    ...
    function Ze(e, r) {
      if (typeof e.ref == "string" && N.current && r && N.current.stateNode !== r) {
        ...
        X[t] || (p('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', P(N.current.type), e.ref), X[t] = true);
      }
    }
    function Qe(e, r) {
      {
...
false ? ee.exports = dr() : ee.exports = vr();
var re = ee.exports;
var pr = (0, import_react.forwardRef)(function({ open: v, onShow: y, onHide: c, children: C, ...x }, h) {
  const [a, d] = (0, import_react.useState)(), { titleBar: b, saveBar: m, modalContent: T } = import_react.Children.toArray(C).reduce(
    (E, k) => {
    ...
    { modalContent: [] }
  ), w = a && a.content ? import_react_dom.default.createPortal(T, a.content) : null;
  return (0, import_react.useEffect)(() => {
    a && (v ? a.show() : a.hide());
  }, [a, v]), (0, import_react.useEffect)(() => {
    if (!(!a || !y))
      return a.addEventListener("show", y), () => {
        a.removeEventListener("show", y);
      };
  }, [a, y]), (0, import_react.useEffect)(() => {
    if (!(!a || !c))
...
var br = "ui-nav-menu";
var _r = "ui-title-bar";
var hr = (0, import_react.forwardRef)(function({ open: v, onShow: y, onHide: c, children: C, ...x }, h) {
